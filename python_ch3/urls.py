...
import emaillist.views as emillist_views
import helloworld.views as helloworld_views

urlpatterns = [
    path('emaillist/', emillist_views.index),
    path('emaillist/form', emillist_views.form),
    path('emaillist/add', emillist_views.add),
